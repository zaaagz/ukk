        ...
        <div class="col-md-12">
             ...
             <?php
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $query = mysqli_query($koneksi, "UPDATE buku SET id_kategori='$id_kategori', judul='$judul', penulis='$penulis', tahun_terbit='$tahun_terbit', deskripsi='$deskripsi' WHERE id_buku=$id");
